...
(function () {
    ...
    g.ocramLayers = _allLayers; //Change: added line
    ...
    if (_battleLayer0 && _battleLayer1 && _battleLayer2) {
        this.debug("All layers are", "inherited to battle scene.");
    ...
    } else if (_battleLayer0 && _battleLayer1) {
        this.debug("Layers 0 and 1 are", "inherited to battle scene.");
    ...
    } else if (_battleLayer0 && _battleLayer2) {
        this.debug("Layers 0 and 2 are", "inherited to battle scene.");
    ...
    } else if (_battleLayer1 && _battleLayer2) {
        this.debug("Layers 1 and 2 are", "inherited to battle scene.");
    ...
    } else if (_battleLayer0) {
        this.debug("Layer 0 is", "inherited to battle scene.");
    ...
    } else if (_battleLayer1) {
        this.debug("Layer 1 is", "inherited to battle scene.");
    ...
    } else if (_battleLayer2) {
        this.debug("Layer 2 is", "inherited to battle scene.");
